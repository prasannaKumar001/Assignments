    ...
    public static void main(String args[]) throws java.lang.Exception {
      ...
      */
        ...
        try {
            ...
            JAXBElement<CustomerData> cusData=_getConnectionAgreement__return.getCustData();
            CustomerData customerData=cusData.getValue();
            System.out.println(customerData.getCustID());
            JAXBElement<String> custmerName=customerData.getCustName();
            System.out.println();
            System.out.println(custmerName.getValue());
